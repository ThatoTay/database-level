    ...
    <div class="profile-box box-left">
      ...
      <?php
        ...
        if($result = mysqli_query($con, $query)) {
          ...
          echo "<div class='info'><strong>Email:</strong> <span>".$row['studentno']."</span></div>";
          echo "<div class='info'><strong>Name:</strong> <span>".$row['firstname']."</span></div>";
          echo "<div class='info'><strong>Surname:</strong> <span>".$row['lastname']."</span></div>";
          echo "<div class='info'><strong>Gender:</strong> <span>".$row['course']."</span></div>";
          echo "<div class='info'><strong>Blood type:</strong> <span>".$row['yrlevel']."</span></div>";
